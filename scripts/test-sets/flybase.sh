...
# mv ./raw/flybase/FBrf_pmid_pmcid_doi_fb.tsv.gz ../../tests/resources/flybase/input/
#
# Fetches all flybase files and creates a raw/flybase directory relative
# to where the script is run
#
# Alleles:
# http://flybase.org/reports/FBal0195705
# http://flybase.org/reports/FBal0190789
#
# Genes:
# FBgn0033159
# FBgn0084473
...
do
    ...
    zgrep ${allele_id} ../disease_model_annotations.tsv.gz >> disease_model_annotations.tsv
