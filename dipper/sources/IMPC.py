...
class IMPC(Source):
    """
    From the [IMPC](https://mousephenotype.org) website:
    ...
    *  We mint three identifiers:
    ...
    files = {
        ...
        'evidence': {  # manually isolated from their mysql data dump circa 2020 May
            ...
            'url': Source.DIPPERCACHE + '/impc/impc_evidence_stable_key.tsv',
            'columns': ['evidence', 'stable', 'key']
        },
    }
        ...
        with open(halfbaked, 'rt') as csvfile:
            ...
            for row in reader:
                ...
                if mp_term_id is None or mp_term_id == '':
                    LOG.warning("No phenotype id specified for row %d", reader.line_num)
                    continue
                # hard coded ECO code
