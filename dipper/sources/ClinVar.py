...
def make_biolink_category_triple(subj, cat):
    ...
    try:
        this_triple = " ".join([subj,
                                expand_curie(blv.terms.category.value),
                                expand_curie(cat),
                                " .\n"])
    except ValueError:
        this_triple = ''
            ...
            for SCV_Assertion in ClinVarSet.findall('./ClinVarAssertion'):
                ...
                for condition in rcv.conditions:
                    ...
                    write_spo(
                        ...
                        'foaf:organization',
                        rcvtriples,
                        subject_category=blv.terms.Provider.value,
                        object_category=blv.terms.Provider.value)
                    ...
                    for SCV_AttributeSet in SCV_Assertion.findall('./AttributeSet'):
                        ...
                        if SCV_Attribute is not None:
                            ...
                            write_spo(
                                ...
                                scv_assert_method + '_assertionmethod',
                                rcvtriples,
                                subject_category=blv.terms.Procedure.value)
                            ...
                            write_spo(
                                ...
                                rcvtriples,
                                subject_category=blv.terms.InformationContentEntity.value,
                                object_category=blv.terms.Procedure.value)
                        ...
                        for SCV_OIMT in SCV_ObsIn.findall('./Method/MethodType'):
                            if SCV_OIMT.text != 'not provided':
                                ...
                                write_spo(
                                    ...
                                    rcvtriples, subject_category=blv.terms.EvidenceType.value)
