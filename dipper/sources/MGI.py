...
class MGI(Source):
    ...
    def _process_bib_acc_view(self, limit):
        ...
        with open(raw, 'r', encoding="utf8") as csvfile:
            ...
            for line in filereader:
                ...
                (accession_key, accid, prefixpart, numericpart, logicaldb_key, object_key,
                 mgitype_key, private, preferred, created_by_key, modified_by_key,
                 creation_date, modification_date, logical_db) = line
    ...
    def _process_prb_strain_view(self, limit):
        ...
        with open(raw, 'r', encoding="utf8") as csvfile:
            ...
            for line in filereader:
                ...
                if line_counter == 1:
                    continue
                (strain_key, species_key, strain_type_key, strain, standard, private, genetic_background,
                 created_by_key, modified_by_key, creation_date, modification_date, species, strain_type,
    ...
    def _process_mrk_summary_view(self, limit):
        ...
        with open(raw, 'r') as f:
            ...
            for line in f:
                ...
                (accession_key, accid, prefixpart, numericpart, logicaldb_key, object_key,
                 mgi_type_key, private, preferred, created_by_key, modified_by_key,
    ...
    def _process_mrk_acc_view(self):
        ...
        with open(raw, 'r') as f:
            ...
            for line in f:
                line_counter += 1
                (accession_key, accid, prefix_part, numeric_part, logicaldb_key, object_key,
                 mgi_type_key, private, preferred, created_by_key, modified_by_key, creation_date,
    ...
    def _process_mrk_acc_view_for_equiv(self, limit):
        ...
        with open('/'.join((self.rawdir, 'mrk_acc_view')), 'r') as f:
            ...
            for line in f:
                ...
                (accession_key, accid, prefix_part, numeric_part, logicaldb_key, object_key,
                 mgi_type_key, private, preferred, created_by_key, modified_by_key,
                 creation_date, modification_date, logicaldb, organism_key) = line.split('\t')
    ...
    def _process_prb_strain_acc_view(self, limit):
        ...
        with open(raw, 'r') as f:
            ...
            for line in f:
                line_counter += 1
                (accession_key, accid, prefixpart, numericpart, logicaldb_key, object_key,
                 mgitype_key, private, preferred, createdby_key, modifiedby_key,
    ...
    def _map_seq_alt_type(sequence_alteration_type):
        ...
        if sequence_alteration_type.strip() in type_map:
            ...
            logger.error("Sequence Alteration Type (%s) not mapped; defaulting to sequence_alteration",
