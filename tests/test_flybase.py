...
class FlyBaseTestCase(SourceTestCase):
    ...
    def testcvterms(self):
        ...
        These are included and intended to be compared against their label, and will fail if they change.
        :return:
        """
        cvterm_list = {
            # 129791: 'derived_sf_assoc_alleles',  # FIXME this is now deprecated
            131502: 'derived_sf_assoc_alleles',  # FIXME this is the new term
            # 129784: 'derived_tp_assoc_alleles',  # FIXME this is now deprecated
            131495: 'derived_tp_assoc_alleles',  # FIXME this is the new term
        ...
        for cvterm in cvterm_list:
            self.assertTrue(cvterm in cvterms_from_file, "cvterm {0} not in file".format(cvterm))
            self.assertTrue(cvterm_list[cvterm] == cvterms_from_file[cvterm],
